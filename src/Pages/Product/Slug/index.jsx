...
import { useGetSingleProduct } from "./hooks/useGetSingle";
import UpdateFrom from "../Component/UpdateFrom";

const SingleProduct = () => {
  const { isError, isLoading, product, handleDelete } = useGetSingleProduct();
    async   function handleChart(productCart) {
        try {
    ...
    <div>
      ...
      <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        ...
        <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
          ...
          <button onClick={() => handleChart(product)} className="dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none text-white bg-gray-800 w-full py-4 hover:bg-gray-700 focus:outline-none">
            <svg
          ...
          <button onClick={() => handleDelete(product._id)} className="bg-red-900 text-white dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none text-white bg-gray-800 w-full py-4 hover:bg-gray-700 focus:outline-none">
